...
if(isset($secondary_menu_bg)){
	if($secondary_menu_bg!="transparent")
		$output .= '.secondary-menu-wrap{ background-color: rgba('.wpsoccer_hex2rgb($secondary_menu_bg).',.6); }';
	else $output .= '.secondary-menu-wrap{ background-color: transparent; }';
}
...
if(isset($footer_background_color)){
	...
	else $output .= '.footer-wrap-inner{ background-color: transparent; }';
}
