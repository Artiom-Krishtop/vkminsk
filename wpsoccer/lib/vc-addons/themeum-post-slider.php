    ...
    foreach ($posts as $post){
        setup_postdata( $post );
             if ( has_post_thumbnail() ) {
                ...
                if( $j == 0 ){
                    $output .= '<div class="item active" style="min-height:500px; background-image: url('.esc_url($image_url[0]).');background-repeat:no-repeat;background-position:50% 25%;background-size:cover;">';// ITGarant edit
                }else{
                    $output .= '<div class="item" style="min-height:500px; background-image: url('.esc_url($image_url[0]).');background-repeat:no-repeat;background-size:cover;background-position:50% 25%;">';
                }
                    ...
                    $output .= '<div class="row">';
                        $output .= '<div class="post-slider-wrap col-md-7 col-sm-7 col-xs-12">';
                            $output .= '<div class="post-slider-in clearfix">';
                                ...
                                //$output .= '<span class="entry-category">'; // ITGarant edit
								...
								$output .= '<a class="btn btn-style" href="'.get_permalink().'">'.esc_html__('Read More','themeum').'</a>';
